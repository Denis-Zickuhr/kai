...
private:
    ...
    // Reordena m_params após um drag confirmado pela tabela (pedido do
    // usuário: "parâmetros dinâmicos são fortamente posicionais, preciso
    // de uma estratégia de reorder") — ver DraggableTableWidget::rowMoved.
