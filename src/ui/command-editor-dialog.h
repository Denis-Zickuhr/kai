...
private slots:
    ...
    // Abre o formulário "Advanced Settings..." (working dir + flags +
    // auto-run) — ver buildAdvancedSettingsFields/buildShellTab.
    void handleAdvancedSettingsClicked();
...
private:
    ...
    // Cria (como membros, sem inserir em nenhum layout ainda) os campos
    // que só aparecem dentro do diálogo "Advanced Settings..." — ver
    // handleAdvancedSettingsClicked.
    void buildAdvancedSettingsFields();
